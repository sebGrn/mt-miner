...
public:
	TreeNode(bool useCloneOptimization, const std::vector<Utils::Itemset>& toTraverse, const std::shared_ptr<BinaryRepresentation>& binaryRepresentation, std::vector<Utils::Itemset>& graph_mt);
	~TreeNode();
