...
namespace MTMinerUnitTests_test
{
	...
	public:
		...
		TEST_METHOD(TestingDisjonctifSupport)
		{
			...
			disjonctifSupport = BinaryRepresentation<bitset_type>::computeDisjonctifSupport(item2);
			...
			disjonctifSupport = BinaryRepresentation<bitset_type>::computeDisjonctifSupport(item3);
			...
			disjonctifSupport = BinaryRepresentation<bitset_type>::computeDisjonctifSupport(item4);
