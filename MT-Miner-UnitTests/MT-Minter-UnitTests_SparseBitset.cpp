...
{
	TEST_CLASS(MTMinerUnitTests_SparseBitset)
	{
	public:
		TEST_METHOD(TestingBitsets_equal)
		{
			SparseIndexBitset b0(1000);
			SparseIndexBitset b1(1000);
		...
		{
			SparseIndexBitset b0(4);
			SparseIndexBitset b1(4);
			SparseIndexBitset b2(4);
